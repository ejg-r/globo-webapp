...
git_secret_id_temp= aws secretsmanager get-secret-value --secret-id "${git_secret_id}" --region us-east-1 --query SecretString --output text > /var/ansible_playbooks/pat.txt
